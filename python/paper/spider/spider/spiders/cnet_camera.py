...
allowed_url = r"http://reviews.cnet.com/.*[.]html?query=camera&searchtype=products"

content_url_format = '//div[contains(@class,"resultInfo")]/a[contains(@class,"resultName")]/@href'

init_start_urls = [
        "http://reviews.cnet.com/1770-6501_7-0.html?query=camera&searchtype=products"
]
...
class SpiderSpider(CrawlSpider):
    ...
    def parse(self, response):
        ...
        list_urls = hxs.select('//ul[contains(@class,"pagination")]/li/a[contains(@href,"query=camera")]/@href').extract()
        ...
        content_re = re.compile(r'http://.*[.]cnet[.]com/.*camera.*/.*[.]html$')
